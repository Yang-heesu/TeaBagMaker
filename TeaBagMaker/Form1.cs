...
namespace TeaBagMaker
{
    public partial class Form1 : Form
    {
        ...
        private void CbTea_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (selectedTea.Equals("녹차")) this.lblCount.Text = "3분";
            else if (selectedTea.Equals("루이보스차")) this.lblCount.Text = "5분";
        }

        private void BtnStart_Click(object sender, EventArgs e)
        {
            if (selectedTea.Equals("홍차") && selectedTea.Equals("국화차")) this.countTime = 60 * 60 * 2;
            else if(selectedTea.Equals("녹차")) this.countTime = 60 * 60 * 3;
            else if(selectedTea.Equals("루이보스차")) this.countTime = 60 * 60 * 5;
        }
